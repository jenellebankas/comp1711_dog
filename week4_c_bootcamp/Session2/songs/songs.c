 ...
 */
 ...
 //functions can only return one thind do pointers used to store info processed in the function
...
int main() {
    ...
    //array of 100 SONG_STRUCTS structs
    SONG_DATA songs[100];
    int buffer_size = 250;
    //lots of space needed for just in case
